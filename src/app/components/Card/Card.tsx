...
const Card = (props: cardProps) => {
  ...
  return (
    <div className="bg-gradient-to-bl from-slate-500 to-slate-700 w-3/4 rounded-md h-12 relative left-12 transition ease-in duration-200 border-2 border-slate-600">
      <Link
